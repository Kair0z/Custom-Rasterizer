...
public:
	...
	Elite::FVector3 GetDirection(const Pixel_Info& pixelInfo) const override final;
	Elite::RGBColor BiradianceValue(const Pixel_Info& pixelInfo) const override final;
