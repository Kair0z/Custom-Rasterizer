...
Elite::FVector3 LPoint::GetDirection(const Pixel_Info& pixelInfo) const
{
	return Elite::GetNormalized(Elite::FVector3{ pixelInfo.GetWorldSpacePoint() - m_Pos });;
}

Elite::RGBColor LPoint::BiradianceValue(const Pixel_Info& pixelInfo) const
{
	return m_Color * (m_Intensity / Elite::SqrDistance(m_Pos, pixelInfo.GetWorldSpacePoint()));
